"""CLI interface for cookiecutter-obsidian-plugin."""
...
@click.command(help="Create a new Obsidian plugin using a cookiecutter template")
@click.option(
    "--output-dir",
    "-o",
...
def main(
    ...
    try:
        click.echo("Creating new Obsidian plugin...")
